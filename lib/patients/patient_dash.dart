              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text("Find doctors", style: TextStyle(color: Colors.white, fontSize: 22, fontFamily: "Montserrat", fontWeight: FontWeight.bold),)
                  ],
                ),
              ),
              GestureDetector(
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text("Billing", style: TextStyle(color: Colors.white, fontSize: 22, fontFamily: "Montserrat", fontWeight: FontWeight.bold),)
                  ],
                ),
              ),
            ],
